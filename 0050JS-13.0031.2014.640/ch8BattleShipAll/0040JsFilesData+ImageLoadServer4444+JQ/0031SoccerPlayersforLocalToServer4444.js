async function saveNewPlayer() {
    ...
    try{
        ...
        alert('New object created on SoccerPlayers with objectId: ' + result.id + 'from 0031js ');
    }catch(error){
...
async function retrievePlayer() {
    ...
    alert("Successfully retrieved SoccerPlayers" + results.length + " scores. from 0031js ");
